...
- **설계 판단은 직접 결정**: 상태 소유권 분류, staleTime/gcTime 정책, 목록 카드에 품절 제외·할인 포함, selector 구독 경계 등을 대화로 근거를 세워 결정했습니다.
- **코드 생성은 AI가 담당**했으며, 각 파일을 검토하고 lint·타입 검사·빌드·수동 동작으로 검증했습니다.
